...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 09:50:49 2020
...
save_dir = '/vol/hinkelstn/codes/'
save_dir_local = '/data/bhossein/'
...
save_file = 'raw_x_all_win2K_s400'
#save_file = 'raw_x_all_win2K_s1600'
...
#torch.save({'IDs':IDs, 'raw_x':raw_x, 'target':target}, save_dir+save_file+'_no_split.pt')
print("Saving unsplit data..." )
torch.save({'IDs':IDs, 'raw_x':raw_x, 'target':target}, save_dir_local+save_file+'_no_split.pt')
...
#raw_x_extend = torch.empty([0,2,t_win])#.to(device)
...
torch.save({'raw_x':raw_x_extend,'target':target_extend,'target_ecg':target,
            'data_tag':data_tag, 'IDs':IDs, 'list_reject':list_reject}, save_dir_local+save_file+'.pt')
