...
print ('''
==============================================================================
Fix-point quantization to int8:
==============================================================================

we performed a fix-point quantization to int8 format.

There is only one de-quantiztion unit in the network in the last layer to get back the output 
...
print ('''
Experiment 1:
All functions in convolution and the fully connected layers are replaced by sigmoids:    
TP: 90.84    FP: 25.76    AF_threshold = 3
    ''')    
    
        
print ('''
Experiment 2:
Only functions in the fully connected layers are replaced by sigmoids:
TP: 99.02    FP: 3.14    AF_threshold = 3
    ''')